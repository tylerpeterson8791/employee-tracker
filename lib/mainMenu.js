...
const viewDepartmentPayroll = require('./view/viewDepartmentPayroll.js');
...
function mainMenu() {
    ...
    .prompt([
        {
            ...
            choices: [
                ...
                { name:'View Department Payroll' , value: "viewDepartmentPayroll" },
    ...
    .then((answer) => {
        ...
        } else if (answer.userSelection  === "viewDepartmentPayroll") {
            viewDepartmentPayroll(mainMenu);
