...
function viewEmployees(mainMenuFunction) {
    ...
    db.query(query, (error, results) => {
        ...
        console.log("List of Employees (fields marked 'null' need updating):");
